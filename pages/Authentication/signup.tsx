...
export default function Login() {
    return (
        <div className="h-screen w-full px-4 bg-white">

            <div className="flex flex-col items-center justify-center h-full">
                <BackButtonDark></BackButtonDark>
                <div className="font-Barrio text-darkgreen text-5xl lg:text-4xl py-4">
                    Plant People
                </div>
                <div className="bg-white shadow-md border-2 rounded-xl lg:w-1/3  md:w-1/2 w-full p-10 ">
                    <p tabIndex={0} role="heading" aria-level={2} aria-label="Login to your account" className="text-2xl font-extrabold leading-6 text-gray-800">
                        Create an account
                    </p>
                    <p className="text-sm mt-4 font-medium leading-none text-gray-500">
                        Have an account?{" "}
                        <Link href="/Authentication/login" className="text-sm font-medium leading-none underline text-gray-800 cursor-pointer">
                            {" "}
                            Log in here
                        </Link>
                    </p>
                    ...
                    <div className="mt-8">
                        <button role="button" aria-label="create my account" className=" text-sm font-semibold leading-none text-darkgreen border-[1px] hover:bg-darkgreen hover:text-white rounded-lg border-darkgreen hover:bg-indigo-600 py-4 w-full">
                            Sign Up
                        </button>
                    </div>
                </div>
