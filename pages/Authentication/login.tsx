...
export default function Login() {
    return (
        <div className="h-screen w-full px-4 bg-darkgreen">
            <div className="flex flex-col items-center justify-center h-full">
                ...
                <div className="bg-white shadow rounded-xl lg:w-1/3  md:w-1/2 w-full p-10 ">
                    ...
                    <p className="text-sm mt-4 font-medium leading-none text-gray-500">
                        ...
                        <Link href="/Authentication/signup" className="text-sm font-medium leading-none underline text-gray-800 cursor-pointer">
                            {" "}
                            Sign up here
                        </Link>
                    </p>
