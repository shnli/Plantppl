...
import ContactExpertButton from "../Buttons/contactExpertButton";

export default function GardenPlant(){
    return(
        <div>
            <div className="h-min-12 rounded-lg border-2 bg-white hover:bg-darkgreen hover:bg-opacity-10 border-darkgreen border-opacity-30">
                <div className="flex justify-between py-2 px-4 lg:px-8 text-xs lg:text-sm text-darkgreen">
                    
                    <Link href="/User/plantProfile" className="flex items-center justify-start gap-2 lg:gap-4 ">
                    ...
                    <div className="flex flex-col justify-center items-end gap-4">
                        ...
                        <div className="text-[10px] border-[1px] border-darkgreen border-opacity-40 px-2 rounded-full py-2 lg:py-0">
                            <ContactExpertButton></ContactExpertButton>
                        </div>
                        <Link href="/User/plantProfile">
